...
im2=ndimage.filters.median_filter(im,size=2)
...
mask = resize(mask,(512,512)).astype(bool)
xcenter = beam_x#*2
ycenter = beam_y#*2
r_min = 5
r_max = 300
...
from healing_scattering_image_packaging import polar_coord,polar_coord_float,qphi_image,oneD_intensity,apply_two_fold_symmetry
